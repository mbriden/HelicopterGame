...
public class SpriteRenderSystem extends EntitySystem {
	...
	protected void process(Entity e) {
		if(pm.has(e)) {
			...
			batch.draw(spriteRegion, posX, posY, 0, 0, (sprite.scaleX * Constants.PIXELS_PER_METER_X), (sprite.scaleY * Constants.PIXELS_PER_METER_Y), 1, 1, sprite.rotation * MathUtils.radiansToDegrees);
